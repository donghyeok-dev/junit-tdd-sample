...
import com.example.tdd1.mart.product.food.MeatType;
...
public class ProductPrice {
    ...
    public ProductPrice() {
        ...
        price.put(MeatType.BEEF, 10000);
        price.put(MeatType.PORK, 6000);
        price.put(MeatType.CHICKEN, 5000);
        price.put(MeatType.DUCK, 7000);
